...
def test_init():
    ...
    criteria = OldStop(direction=StopDirection.UP, percent=0.3)
...
def test_call_with_direction_down(mock_order_class, mock_exchange_class):
    ...
    criteria = OldStop(direction=StopDirection.DOWN, percent=0.03)
...
def test_call_with_direction_up(mock_order_class, mock_exchange_class):
    ...
    criteria = OldStop(direction=StopDirection.UP, percent=0.03)
